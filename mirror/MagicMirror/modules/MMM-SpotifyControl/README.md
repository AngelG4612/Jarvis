...
This document explains how to configure Spotify for the `MMM-SpotifyControl` / `MMM-SpotifyPlayer` modules and how to obtain the required tokens (client ID, client secret, and refresh token). It includes safe deployment options so you do not expose secrets to the browser.
